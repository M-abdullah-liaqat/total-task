...
const TeamTasks = () => {
  ...
  const CurrentTeam = teams?.find((doc) => doc.teamId === TeamId);
    ...
    <div className="flex flex-col gap-4">
      <h1 className="sticky top-0 z-[10] flex items-center justify-between border-b bg-background/50 p-6 md:text-4xl text-2xl backdrop-blur-lg">
        <span className="font-semibold">
          Team {CurrentTeam ? CurrentTeam.teamName : "Team"}
        </span>
        <button
      ...
      <div className="grid lg:grid-cols-4 grid-cols-2 md:gap-4 gap-2 px-7">
        ...
        <div
          onClick={() => settsakStatus("inProgress")}
          className={` ${
        ...
        <div
          onClick={() => settsakStatus("complected")}
          className={` ${
